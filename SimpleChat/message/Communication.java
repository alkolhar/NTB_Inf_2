...
public class Communication {
    ...
    public Message getMessage() {
        try {
            ...
            ObjectInputStream objIn = new ObjectInputStream (new ByteArrayInputStream (receivePacket.getData ()));
    ...
    public void sendMessage(SocketAddress address, Message message) {
        try {
            ...
            DatagramPacket packet = new DatagramPacket(byteStream.toByteArray(), byteStream.toByteArray().length, address);
